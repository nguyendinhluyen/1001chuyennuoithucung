...
function InnovaEditorUtil()
{
    ...
    for (var i = 0; i < oScripts.length; i++)
    {
        ...
        if (sSrc.indexOf("moz/editor.js") != -1)
        {
            ...
            (sSrc.indexOf("scripts/innovaeditor.js") != -1)/*optional, kalau embed innovaeditor.js (khusus firefox perlu)*/
        {
            if (!this.scriptPath)
...
function setEdit(oName) {
    if ((oName != null) && (oName != "")) {
        try {
            document.getElementById("idContent" + oName).contentDocument.designMode = "on";
        } catch (e) {
        }
    } else {
        for (var i = 0; i < this.arrEditor.length; i++) {
            try {
                document.getElementById("idContent" + this.arrEditor[i]).contentDocument.designMode = "on";
            } catch (e) {
            }
        }
    }
...
function saveForUndo()
{
    ...
    if (this.btnUndo)
        makeEnableNormal(document.getElementById("btnUndo" + this.oName));
    if (this.btnRedo)
        makeDisabled(document.getElementById("btnRedo" + this.oName));
}
...
function doUndoRedo(listA, listB)
{
    ...
    var obj = this;
    if (!listA[0])
        return; //return of undo/redo array empty
...
function RENDER(sPreloadHTML)
{
    ...
    for (var i = 0; i < this.buttonMap.length; i++)
    {
        ...
        switch (sButtonName)
        {
            ...
            case "Print":
                if (this.btnPrint)
                    sHTMLIcons += this.writeIconStandard("btnPrint" + this.oName, "document.getElementById('idContent" + this.oName + "').contentWindow.print()", "btnPrint.gif", getText("Print"));
                break;
            ...
            case "PasteWord":
                if (this.btnPasteWord)
                    sHTMLIcons += this.writeIconStandard("btnPasteWord" + this.oName, "modelessDialogShow('" + this.scriptPath + "paste_word.htm',400,280)", "btnPasteWord.gif", getText("Paste from Word"));
                break;
            case "Bold":
                if (this.btnBold)
            ...
            case "Bookmark":
                if (this.btnBookmark)
                    sHTMLIcons += this.writeIconStandard("btnBookmark" + this.oName, "modelessDialogShow('" + this.scriptPath + "bookmark.htm',245,170)", "btnBookmark.gif", getText("Bookmark"));
                break;
            case "Hyperlink":
                if (this.btnHyperlink)
                    sHTMLIcons += this.writeIconStandard("btnHyperlink" + this.oName, "modelessDialogShow('" + this.scriptPath + "hyperlink.htm',420,150)", "btnHyperlink.gif", getText("Hyperlink"));
                break;
            case "CustomTag":
            ...
            case "Image":
                if (this.btnImage)
                    sHTMLIcons += this.writeIconStandard("btnImage" + this.oName, "modelessDialogShow('" + this.scriptPath + "image.htm',440,305)", "btnImage.gif", getText("Image"));
                break;
            case "Flash":
                if (this.btnFlash)
                    sHTMLIcons += this.writeIconStandard("btnFlash" + this.oName, "modelessDialogShow('" + this.scriptPath + "flash.htm',410,205)", "btnFlash.gif", getText("Flash"));
                break;
            case "Media":
                if (this.btnMedia)
                    sHTMLIcons += this.writeIconStandard("btnMediah" + this.oName, "modelessDialogShow('" + this.scriptPath + "media.htm',420,232)", "btnMedia.gif", getText("Media"));
                break;
            case "ContentBlock":
                if (this.btnContentBlock)
                    sHTMLIcons += this.writeIconStandard("btnContentBlock" + this.oName, this.cmdContentBlock, "btnContentBlock.gif", getText("Content Block"));
                break;
            case "InternalLink":
                if (this.btnInternalLink)
                    sHTMLIcons += this.writeIconStandard("btnInternalLink" + this.oName, this.cmdInternalLink, "btnInternalLink.gif", getText("Internal Link"));
                break;
            case "CustomObject":
                if (this.btnCustomObject)
                    sHTMLIcons += this.writeIconStandard("btnCustomObject" + this.oName, this.cmdCustomObject, "btnCustomObject.gif", getText("Object"));
                break;
            case "Table":
                if (this.btnTable)
                {
            ...
            case "Characters":
                if (this.btnCharacters)
                    sHTMLIcons += this.writeIconStandard("btnCharacters" + this.oName, "modelessDialogShow('" + this.scriptPath + "characters.htm',520,150)", "btnSymbol.gif", getText("Special Characters"));
                break;
            case "Line":
                if (this.btnLine)
...
function realTime(edtObj)
{
    ...
    if (edtObj.btnFontSize)
    {
        if (oEditor.document.queryCommandEnabled("FontSize"))
            ...
            makeDisabled(edtObj.arrElm[6]);
    }
    if (edtObj.btnUndo)
    {
        if (!edtObj.arrUndoList[0])
            makeDisabled(edtObj.arrElm[12]);
        else
            makeEnableNormal(edtObj.arrElm[12]);
    }
    if (edtObj.btnRedo)
    {
        if (!edtObj.arrRedoList[0])
            makeDisabled(edtObj.arrElm[13]);
        else
            makeEnableNormal(edtObj.arrElm[13]);
    }
    ...
    if (edtObj.btnBold)
    {
        if (oEditor.document.queryCommandEnabled("Bold"))
        {
            if (oEditor.document.queryCommandState("Bold"))
                ...
                makeEnableNormal(edtObj.arrElm[14]);
        } else
            makeDisabled(edtObj.arrElm[14]);
    }
    if (edtObj.btnItalic)
    {
        if (oEditor.document.queryCommandEnabled("Italic"))
        {
            if (oEditor.document.queryCommandState("Italic"))
                ...
                makeEnableNormal(edtObj.arrElm[15]);
        } else
            makeDisabled(edtObj.arrElm[15]);
    }
    if (edtObj.btnUnderline)
    {
        if (oEditor.document.queryCommandEnabled("Underline"))
        {
            if (oEditor.document.queryCommandState("Underline"))
                ...
                makeEnableNormal(edtObj.arrElm[16]);
        } else
            makeDisabled(edtObj.arrElm[16]);
    }
    if (edtObj.btnStrikethrough)
    {
        if (oEditor.document.queryCommandEnabled("Strikethrough"))
        {
            if (oEditor.document.queryCommandState('Strikethrough'))
                ...
                makeEnableNormal(edtObj.arrElm[17]);
        } else
            makeDisabled(edtObj.arrElm[17]);
    }
    if (edtObj.btnSuperscript)
    {
        if (oEditor.document.queryCommandEnabled("Superscript"))
        {
            if (oEditor.document.queryCommandState("Superscript"))
                ...
                makeEnableNormal(edtObj.arrElm[18]);
        } else
            makeDisabled(edtObj.arrElm[18]);
    }
    if (edtObj.btnSubscript)
    {
        if (oEditor.document.queryCommandEnabled("Subscript"))
        {
            if (oEditor.document.queryCommandState("Subscript"))
                ...
                makeEnableNormal(edtObj.arrElm[19]);
        } else
            makeDisabled(edtObj.arrElm[19]);
    }
    if (edtObj.btnNumbering)
    {
        if (oEditor.document.queryCommandEnabled("InsertOrderedList"))
        {
            if (oEditor.document.queryCommandState("InsertOrderedList"))
                ...
                makeEnableNormal(edtObj.arrElm[20]);
        } else
            makeDisabled(edtObj.arrElm[20]);
    }
    if (edtObj.btnBullets)
    {
        if (oEditor.document.queryCommandEnabled("InsertUnorderedList"))
        {
            if (oEditor.document.queryCommandState("InsertUnorderedList"))
                ...
                makeEnableNormal(edtObj.arrElm[21]);
        } else
            makeDisabled(edtObj.arrElm[21]);
    }
    if (edtObj.btnJustifyLeft)
    {
        if (oEditor.document.queryCommandEnabled("JustifyLeft"))
        {
            if (oEditor.document.queryCommandState("JustifyLeft"))
                ...
                makeEnableNormal(edtObj.arrElm[22]);
        } else
            makeDisabled(edtObj.arrElm[22]);
    }
    if (edtObj.btnJustifyCenter)
    {
        if (oEditor.document.queryCommandEnabled("JustifyCenter"))
        {
            if (oEditor.document.queryCommandState("JustifyCenter"))
                ...
                makeEnableNormal(edtObj.arrElm[23]);
        } else
            makeDisabled(edtObj.arrElm[23]);
    }
    if (edtObj.btnJustifyRight)
    {
        if (oEditor.document.queryCommandEnabled("JustifyRight"))
        {
            if (oEditor.document.queryCommandState("JustifyRight"))
                ...
                makeEnableNormal(edtObj.arrElm[24]);
        } else
            makeDisabled(edtObj.arrElm[24]);
    }
    if (edtObj.btnJustifyFull)
    {
        if (oEditor.document.queryCommandEnabled("JustifyFull"))
        {
            if (oEditor.document.queryCommandState("JustifyFull"))
                ...
                makeEnableNormal(edtObj.arrElm[25]);
        } else
            makeDisabled(edtObj.arrElm[25]);
    }
    if (edtObj.btnIndent)
    {
    ...
    if (element)
    {
        if (edtObj.btnForeColor)
            makeEnableNormal(edtObj.arrElm[30]);
        if (edtObj.btnBackColor)
            makeEnableNormal(edtObj.arrElm[31]);
        if (edtObj.btnLine)
            makeEnableNormal(edtObj.arrElm[32]);
        //if(edtObj.btnClean)makeEnableNormal(document.getElementById("btnClean"+oName));
    } else
    {
        if (edtObj.btnForeColor)
            makeDisabled(edtObj.arrElm[30]);
        if (edtObj.btnBackColor)
            makeDisabled(edtObj.arrElm[31]);
        if (edtObj.btnLine)
            makeDisabled(edtObj.arrElm[32]);
...
function applyJustifyLeft()
{
    ...
    if (this.btnJustifyCenter)
        makeEnableNormal(document.getElementById("btnJustifyCenter" + this.oName));
    if (this.btnJustifyRight)
        makeEnableNormal(document.getElementById("btnJustifyRight" + this.oName));
    if (this.btnJustifyFull)
        makeEnableNormal(document.getElementById("btnJustifyFull" + this.oName));
}
...
function applyJustifyCenter()
{
    ...
    if (this.btnJustifyLeft)
        makeEnableNormal(document.getElementById("btnJustifyLeft" + this.oName));
    if (this.btnJustifyRight)
        makeEnableNormal(document.getElementById("btnJustifyRight" + this.oName));
    if (this.btnJustifyFull)
        makeEnableNormal(document.getElementById("btnJustifyFull" + this.oName));
...
function applyBlockDirLTR()
{
    ...
    if (oEl.dir)
        ...
        oEl.dir = "ltr";
    if (this.btnRTL)
        makeEnableNormal(document.getElementById("btnRTL" + this.oName));
    this.focus();
}
...
function applyBlockDirRTL()
{
    ...
    if (oEl.dir)
        ...
        oEl.dir = "rtl";
    if (this.btnLTR)
        makeEnableNormal(document.getElementById("btnLTR" + this.oName));
    this.focus();
}
...
function modalDialogShow(url, width, height)
{
    ...
    window.onfocus = function () {
        if (oUtil.activeModalWin.closed == false) {
            oUtil.activeModalWin.focus();
        }
        ;
    };
}
...
{
    if (this.btnPreview)
        document.getElementById("dropPreview" + this.oName).style.display = "none";
    if (this.btnTextFormatting || this.btnParagraphFormatting || this.btnListFormating || this.btnBoxFormatting || this.btnStyles || this.btnCssText)
        document.getElementById("dropStyle" + this.oName).style.display = "none";
    if (this.btnParagraph)
        document.getElementById("dropParagraph" + this.oName).style.display = "none";
    if (this.btnFontName)
        document.getElementById("dropFontName" + this.oName).style.display = "none";
    if (this.btnFontSize)
        document.getElementById("dropFontSize" + this.oName).style.display = "none";
    if (this.btnTable)
        document.getElementById("dropTable" + this.oName).style.display = "none";
    if (this.btnTable)
        document.getElementById("dropTableCreate" + this.oName).style.display = "none";
    if (this.btnForm)
        document.getElementById("dropForm" + this.oName).style.display = "none";
    if (this.btnCustomTag)
        document.getElementById("dropCustomTag" + this.oName).style.display = "none";
...
function doDown(btn)
{
    ...
    if (btnArr[0] != "disabled")
        btn.style.top = (-48 + iconOffsetTop) + "px";//no.3
}
...
function doOut(btn)
{
    ...
    btnArr = buttonArrays[btn.id];
    if (btnArr[0] == "active")
        btn.style.top = (-72 + iconOffsetTop) + "px";//no.4 (remain active/pushed)
    if (btnArr[0] == "inactive")
        btn.style.top = (0 + iconOffsetTop) + "px";//no.1 (remain inactive)
}
...
function doUpToggle(btn)
{
    if (bCancel)
    {
        //lagi pushed tapi mouseout (cancel)
        bCancel = false;
        btn.style.top = (0 + iconOffsetTop) + "px";
        ;
        return false;
    }
    btnArr = buttonArrays[btn.id];
