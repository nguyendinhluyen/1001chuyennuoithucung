                        ...
                        <div id="top" class="callbacks_container">
                            <ul class="rslides callbacks callbacks1" id="slider4">
                                ...
                                <li id="callbacks1_s2" class="" style="display: block; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out;">
                                    <div class="banner-info">
                                        <h3>Thú cưng</h3>
                                        <h4>Tin tức dành cho thú cưng</h4>
                                    </div>	
                                </li>
                            </ul>
                        </div>                        
            ...
            <div class="footer text-center">
                <div class="container">
                    <ul class="social-icons">
                        <li><a class="tooltips" href="#">
                            <img src="{linkS}petsylayout/images/fb.png" title="facebook"/>
                            <span>Vào fanpage để cập nhật thông tin mới nhất</span></a></li>
                        <li><a class="tooltips" href="#">
                            <img src="{linkS}petsylayout/images/twt.png" title="twitter"/>
                            <span>Vào fanpage để cập nhật thông tin mới nhất</span></a></li>
                        <li><a class="tooltips" href="#">
                            <img src="{linkS}petsylayout/images/tube.png" title="tube"/>
                            <span>Vào fanpage để cập nhật thông tin mới nhất</span></a></li>
                        <li><a class="tooltips" href="#">
                            <img src="{linkS}petsylayout/images/in.png" title="linkedin"/>
                            <span>Vào fanpage để cập nhật thông tin mới nhất</span></a></li>                                                
                    </ul>
                    <div class="clearfix"> </div>
                    <div class="copy">
                        <p>Copyright &copy; 2017 1001chuyennuoithucung.com</p>
                    </div>
                </div>
            </div>
        </footer>
